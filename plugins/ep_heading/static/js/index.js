...
export const aceRegisterBlockElements = () => tags;
...
const range = (start, end) =>
    Array.from(new Array(Math.abs(end - start) + 1), (_, i) => start + i);
...
export const aceAttribsToClasses = (hookName, context) => {
...
export const aceEditorCSS = () => cssFiles;